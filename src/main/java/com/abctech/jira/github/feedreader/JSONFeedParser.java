...
public class JSONFeedParser {
    ...
    public Feed getFeed() {
        ...
        Feed feed = new Feed();
        try {
            feed = m.readValue(TEST_JSON, Feed.class);
        } catch(IOException e) {
